            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <motion.div
                        ...
                        className="relative bg-card/95 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl w-full max-w-4xl max-h-[85vh] flex flex-col overflow-hidden"
                        onClick={(e) => e.stopPropagation()}
                    >
                        {/* Header */}
                        <div className="sticky top-0 bg-card/95 backdrop-blur-xl border-b border-white/10 px-6 py-4 sm:px-8 sm:py-5 flex items-center justify-between">
                        ...
                        <div className="overflow-y-auto px-6 py-6 sm:px-8 sm:py-8">
                            <div className="prose prose-invert prose-sm sm:prose-base max-w-none">
                                <p className="text-white/60 text-sm">Last updated: December 02, 2025</p>
                                ...
                                <h2 className="text-white font-bold text-xl sm:text-2xl mt-8 mb-4">Interpretation and Definitions</h2>

                                <h3 className="text-white font-semibold text-lg sm:text-xl mt-6 mb-3">Interpretation</h3>
                                <p className="text-white/80">
                                    The words whose initial letters are capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
                                </p>

                                <h3 className="text-white font-semibold text-lg sm:text-xl mt-6 mb-3">Definitions</h3>
                                <p className="text-white/80">For the purposes of this Privacy Policy:</p>

                                <ul className="space-y-3 mt-4 text-white/80 list-disc pl-6">
                                    <li>
                                    ...
                                    <li>
                                        <strong className="text-white">Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to webcasus.com, 601 S Figueroa St, Los Angeles, CA 90017, United States.
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <strong className="text-white">Usage Data</strong> refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).
                                    </li>
                                    <li>
                                        <strong className="text-white">Website</strong> refers to webcasus.com, accessible from <a href="http://webcasus.com/" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">http://webcasus.com/</a>
                                    </li>
                                    <li>
                                ...
                                <h2 className="text-white font-bold text-xl sm:text-2xl mt-8 mb-4">Collecting and Using Your Personal Data</h2>

                                <h3 className="text-white font-semibold text-lg sm:text-xl mt-6 mb-3">Types of Data Collected</h3>

                                <h4 className="text-white font-semibold text-base sm:text-lg mt-5 mb-2">Personal Data</h4>
                                <p className="text-white/80">
                                    While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:
                                </p>

                                <ul className="space-y-2 mt-3 text-white/80 list-disc pl-6">
                                    <li>Email address</li>
                                ...
                                <h4 className="text-white font-semibold text-base sm:text-lg mt-5 mb-2">Usage Data</h4>
                                <p className="text-white/80">Usage Data is collected automatically when using the Service.</p>
                                ...
                                <h4 className="text-white font-semibold text-base sm:text-lg mt-5 mb-2">Tracking Technologies and Cookies</h4>
                                <p className="text-white/80">
                                ...
                                <p className="text-white/80 mt-3">We use both Session and Persistent Cookies for the purposes set out below:</p>

                                <ul className="space-y-4 mt-4 text-white/80">
                                    <li>
                                        <div className="bg-white/5 p-4 rounded-lg border border-white/10">
                                            <strong className="text-white block mb-2">Necessary / Essential Cookies</strong>
                                            <p className="text-sm"><strong>Type:</strong> Session Cookies</p>
                                            <p className="text-sm"><strong>Administered by:</strong> Us</p>
                                            <p className="text-sm mt-2"><strong>Purpose:</strong> These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those services.</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="bg-white/5 p-4 rounded-lg border border-white/10">
                                            <strong className="text-white block mb-2">Cookies Policy / Notice Acceptance Cookies</strong>
                                            <p className="text-sm"><strong>Type:</strong> Persistent Cookies</p>
                                            <p className="text-sm"><strong>Administered by:</strong> Us</p>
                                            <p className="text-sm mt-2"><strong>Purpose:</strong> These Cookies identify if users have accepted the use of cookies on the Website.</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="bg-white/5 p-4 rounded-lg border border-white/10">
                                            <strong className="text-white block mb-2">Functionality Cookies</strong>
                                            <p className="text-sm"><strong>Type:</strong> Persistent Cookies</p>
                                            <p className="text-sm"><strong>Administered by:</strong> Us</p>
                                            <p className="text-sm mt-2"><strong>Purpose:</strong> These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website.</p>
                                        </div>
                                    </li>
                                </ul>

                                <h3 className="text-white font-semibold text-lg sm:text-xl mt-6 mb-3">Use of Your Personal Data</h3>
                                <p className="text-white/80">The Company may use Personal Data for the following purposes:</p>
                                ...
                                <p className="text-white/80 mt-4">We may share Your personal information in the following situations:</p>
                                ...
                                <h3 className="text-white font-semibold text-lg sm:text-xl mt-6 mb-3">Retention of Your Personal Data</h3>
                                <p className="text-white/80">
                                ...
                                <h3 className="text-white font-semibold text-lg sm:text-xl mt-6 mb-3">Transfer of Your Personal Data</h3>
                                <p className="text-white/80">
                                ...
                                <h3 className="text-white font-semibold text-lg sm:text-xl mt-6 mb-3">Delete Your Personal Data</h3>
                                <p className="text-white/80">
                                ...
                                <h3 className="text-white font-semibold text-lg sm:text-xl mt-6 mb-3">Disclosure of Your Personal Data</h3>

                                <h4 className="text-white font-semibold text-base sm:text-lg mt-5 mb-2">Business Transactions</h4>
                                <p className="text-white/80">
                                    If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
                                </p>

                                <h4 className="text-white font-semibold text-base sm:text-lg mt-5 mb-2">Law enforcement</h4>
                                <p className="text-white/80">
                                    Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
                                </p>

                                <h4 className="text-white font-semibold text-base sm:text-lg mt-5 mb-2">Other legal requirements</h4>
                                <p className="text-white/80">The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:</p>
                                ...
                                <h3 className="text-white font-semibold text-lg sm:text-xl mt-6 mb-3">Security of Your Personal Data</h3>
                                <p className="text-white/80">
                                    The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially reasonable means to protect Your Personal Data, We cannot guarantee its absolute security.
                                </p>

                                <h2 className="text-white font-bold text-xl sm:text-2xl mt-8 mb-4">Children's Privacy</h2>
                                <p className="text-white/80">
                                ...
                                <h2 className="text-white font-bold text-xl sm:text-2xl mt-8 mb-4">Links to Other Websites</h2>
                                <p className="text-white/80">
                                ...
                                <h2 className="text-white font-bold text-xl sm:text-2xl mt-8 mb-4">Changes to this Privacy Policy</h2>
                                <p className="text-white/80">
                                ...
                                <h2 className="text-white font-bold text-xl sm:text-2xl mt-8 mb-4">Contact Us</h2>
                                <p className="text-white/80">If you have any questions about this Privacy Policy, You can contact us:</p>

                                <ul className="space-y-2 mt-3 text-white/80 list-disc pl-6">
                                    <li>
                                        By email: <a href="mailto:support@webcasus.com" className="text-primary hover:underline">support@webcasus.com</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
